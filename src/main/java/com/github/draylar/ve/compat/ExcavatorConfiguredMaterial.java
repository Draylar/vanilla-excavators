...
public class ExcavatorConfiguredMaterial extends ConfiguredMaterial {
	public ExcavatorConfiguredMaterial(ConfiguredMaterial mat) {
	...
	public ExcavatorConfiguredMaterial(String name, String color, String matId, String blockMatId, int enchantability,
									   ...
									   int armorDurabilityMultiplier, int[] protectionAmounts, float toughness, SoundEvent equipSound)
	{
		super(name, color, matId, blockMatId, enchantability,
				toolDurability* VanillaExcavators.DURABILITY_MODIFIER, miningLevel, miningSpeed, attackDamage,
